  ...
  ;(n.d = (e, t) => {
    ...
    (() => {
      ...
      var t = '#/shipping',
        ...
        l = 'tvfields',
        d = 'pickup',
        h = ['bash.com', 'preprod--thefoschini.myvtex.com'].includes(
      ...
      function L(e, t = {}) {
        if (
          ...
          t.sid && (e.sid = 32 === t.sid.length ? t.sid : f()),
      ...
      class T {
        ...
        addBreadcrumb(e, t) {
          ...
          if (!r) return
          const { beforeBreadcrumb: o = null, maxBreadcrumbs: i = N } =
        ...
        endSession() {
          ...
          t &&
            (function (e, t) {
              let n = {}
              'ok' === e.status && (n = { status: 'exited' }), L(e, n)
            })(t),
            this._sendSessionUpdate(),
            e.setSession()
        }
        startSession(e) {
          const { scope: t, client: n } = this.getStackTop(),
            { release: r, environment: o = _ } = (n && n.getOptions()) || {},
            { userAgent: i } = p.n2.navigator || {},
            a = (function (e) {
              const t = (0, v.ph)(),
                n = {
                  sid: f(),
          ...
          return (
            s && 'ok' === s.status && L(s, { status: 'exited' }),
            this.endSession(),
            t.setSession(a),
            a
          )
      ...
      function F() {
        return (
          (p.n2.__SENTRY__ = p.n2.__SENTRY__ || {
            extensions: {},
            hub: void 0,
          }),
          p.n2
      ...
      const ee = function (e) {
        ...
        var n,
          ...
          f = [
            u,
            ((n = q(h || d)),
            [n.slice(0, 3), n.slice(3, 6), n.slice(6)].join(' ')),
          ].join(' - '),
          v =
            null === (t = window) ||
            void 0 === t ||
        ...
        function w(e, t) {
          function o(r, i, a, s) {
            ...
            if ('throw' !== c.type) {
              var u = c.arg,
                d = u.value
              return d && 'object' == re(d) && n.call(d, '__await')
      ...
      var de = new ((function () {
        ...
        ve = function (e) {
          ...
          t.length
            ? (t.after(ee(e)), t.remove(), (t = null))
            : $('#bash-address-list').append(ee(e)),
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      t.addressName ||
                        ...
                        de.addOrUpdateAddress(t).then(function () {
                          return ve(t)
                        }),
                        fe(t)
                    case 4:
        ...
        we = function (e) {
          ...
          return (
            n &&
              ...
              n.customApps.forEach(function (t) {
                t.id === e && (r = t.fields)
              }),
            r
          )
      ...
      var Fe = function () {
        ...
        Re = function (e) {
          ...
          var S = ''
            ...
            .replace(', '.concat(d), '')
          'commercial' === u &&
            ($('#radio-addressType-business').click(), Z({ focus: !1 })),
            l &&
              (document.getElementById('bash--input-businessName').value = l),
          ...
          if (window.google) {
            ...
            if (e) {
              ...
              window.google.maps.event.addListener(
                ...
                null == e || e.addEventListener('keyup', Be)
            }
          }
        },
        qe = function (e, t) {
        ...
        Ue = function (e) {
          var t =
            ...
            a = xe,
            s = []
          o && t && (a = [].concat(je(a), je(Se))),
            i && t && (a = [].concat(je(a), je(ke)))
        ...
        Ze = function () {
          ...
          var e =
            $('[data-view="address-form"]').length > 0
              ? 'Address added'
              : 'Address updated'
      ...
      const it =
                      ...
                      be(d, { phone: e }).then(function () {
                        ...
                        ;(t = n.receiverName),
                          ...
                          t &&
                            r &&
                            ($(
                              '.vtex-omnishipping-1-x-SummaryItemAddress .collect-receiver'
                            ).length
                              ? $('.collect-receiver').html(
                                  ''.concat(t, ' - ').concat(r, ' ')
                                )
                              : $(
          ...
          (rt = function () {
            var n,
              i,
              a = $('#postalCode-finished-loading').length > 0
        ...
        return (
          ...
          window.vtexjs.checkout
            ...
            .then(function (t) {
              ...
              e.addressName && ve(e),
                console.info('### Update customData ###', { address: e })
              try {
                ut({
        ...
        var e,
          t =
            ((e = bt().mark(function e(t) {
              var n, o, i, a, s, c, d, h, p, f, v, m, y, g, b, w, _
          ...
          n = function () {
            if (
              ...
              if (window.vtexjs.checkout.orderForm) {
                var n,
                  r =
                    null === (n = window.vtexjs.checkout.orderForm) ||
                    void 0 === n
                      ? void 0
                      : n.items,
                  o = Y(r),
                  ...
                  a = o.hasTVs,
                  s = o.hasSimCards,
                  c = o.hasFurnitureMixed,
                  u = o.hasFurnitureOnly
                ;(e.hasFurn = i),
                  (e.hasTVs = a),
                  (e.hasSim = s),
                  (e.hasFurnOnly = u),
              ...
              $('.shipping-data .box-step').append(
                st({ hasFurnOnly: e.hasFurnOnly, hasFurnMixed: e.hasFurnMixed })
              ),
                e.hasFurn
                ...
                (e.hasFurn || e.hasSim || e.hasTVs) &&
                  ($('#bash-delivery-options').before(
                    ct({ hasSim: e.hasSim, hasTV: e.hasTVs })
                  ),
                  e.hasSim && Ge(),
                  e.hasTVs && Ve()),
            ...
            var e,
              ...
              a =
                null === (e = window.vtexjs.checkout.orderForm) || void 0 === e
                  ...
                  : e.items,
              s =
                null === (i = window.vtexjs.checkout.orderForm.shippingData) ||
                void 0 === i ||
                null === (i = i.address) ||
                void 0 === i
                  ? void 0
              ...
              d = c.hasTVs,
              h = c.hasSimCards,
              p = c.hasFurnitureMixed,
              f = window.vtexjs.checkout.orderForm.messages
              ...
              (function () {
                if (window.vtexjs.checkout.orderForm.totalizers) {
                  var e = (
                    ...
                    t = 'Free'
                  e > 0 &&
                    (t = 'R'.concat((e / 100).toFixed(2).replace('.00', ''))),
      ...
      Nt.setAttribute('src', 'https://unpkg.com/penpal@^6/dist/penpal.min.js'),
