...
const ContactCard = (data) => /* html */ `
  <div style="border: 0.5px solid #0404041A; border-radius: 8px; padding: 16px; display: flex;">
      ...
      <div style="margin-left: 16px;">
        <p style="line-height: 1; font-size: 14px">${JSON.stringify(data)}</p>
        <p style="line-height: 1; font-size: 14px">Delivery Address</p>
        <p style="line-height: 1; font-size: 14px">Delivery Address</p>
        <p style="line-height: 1; font-size: 14px">Delivery Address</p>
      </div>
  </div>
