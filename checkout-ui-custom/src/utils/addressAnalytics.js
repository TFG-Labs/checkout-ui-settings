 ...
 * @param {ADD_ADDRESS_METHOD[keyof typeof ADD_ADDRESS_METHOD]} params.add_address_method - The method used to add the address. Use one of the values from `ADD_ADDRESS_METHOD` (e.g., `ADD_ADDRESS_METHOD.SEARCH_FOR_AN_ADDRESS`).
